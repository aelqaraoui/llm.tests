...
const get_embeddings = async (prompt) => {
...
`;
        ...
        if (completion) {
            ...
            let similarity = cosine_similarity(await get_embeddings(completion), await get_embeddings(dataset[i]['response']));
            console.log(similarity);
            similarities.push(similarity);
        }
        console.log("The average similarity score for example 1 on the testset : ", average(similarities));
    }
};
test_prompt();
